...
CREATE EXTERNAL TABLE BillingReport.billing_report(
	...
	cost_category_development STRING,
	cost_category_production STRING
)
...
) LOCATION 's3://my-cur-bucket-daitruo/cur/BillingReport/BillingReport/'
